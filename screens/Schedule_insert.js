...
function Schedule_insert({ navigation }) {
    const done = () => {
        navigation.navigate('Tab');
    };
    {/* 날짜  */}
    const placeholderDate = "날짜를 입력해주세요";
    const [startDate, onStartDateChangeText] = useState("");
    const [endDate, onEndDateChangeText] = useState("");
    ...
    const startDateHandleConfirm = (date) => {
        startHideDatePicker();
        onStartDateChangeText(date.format("yyyy/MM/dd"));
    };
    const endDateHandleConfirm = (date) => {
        endHideDatePicker();
        onEndDateChangeText(date.format("yyyy/MM/dd"));
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.headerText}>스케줄 추가</Text>
            </View>
